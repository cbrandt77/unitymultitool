 ...
 * @author impro_000
 */
public class FileImportPixellotCSV extends javax.swing.JFrame {

    /**
     * Creates new form FileImportPixellotCSV
     */
    public FileImportPixellotCSV() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileImportPixellotCSV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new FileImportPixellotCSV().setVisible(true);
            }
        });
    }
